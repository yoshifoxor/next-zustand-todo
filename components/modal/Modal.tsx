...
export default function Modal({
  ...
  return (
    <div
      className="fixed left-0 top-0 z-50 flex size-full animate-fade items-center overflow-auto bg-black/60 animate-normal animate-duration-[150ms] animate-fill-forwards animate-once animate-ease-out"
